            ...
            try (IndexWriter writer = new IndexWriter(dir, cfg)) {
                Files.walkFileTree(root, new SimpleFileVisitor<Path>() {
                    ...
                    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
                        try {
                            ...
                            try {
                                ...
                                System.err.println("WARN: Could not parse content or mime for " + file + ", error: " + e.getMessage());
                            }
                            ...
                            System.err.println("WARN: Failed to index file " + file + ", error: " + e.getMessage());
                        }
                        return FileVisitResult.CONTINUE;
                    }
                    ...
                    public FileVisitResult visitFileFailed(Path file, IOException exc) {
                        System.err.println("WARN: Failed to access file " + file + ", error: " + exc.getMessage());
                        return FileVisitResult.CONTINUE;
                    }
                });
                writer.commit();
